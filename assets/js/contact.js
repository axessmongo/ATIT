document.addEventListener("DOMContentLoaded", function () {
 ...
 const scriptutldev = "https://script.google.com/macros/s/AKfycbxHha_XQ3qKAYbsGZoeK0VtaMJsIvkW1i0yaMqYtsQLPcd9q_Y5N_bYJNJT2ug1p-LaXg/exec"
  ...
  form.addEventListener("submit", function (event) {
    ...
    Promise.all([
       fetch(scriptURLAdmin, { method: "POST", body: new FormData(form) }),
      fetch(scriptURLMD, { method: "POST", body: new FormData(form) }),
      fetch(scriptutldev, { method: "POST", body: new FormData(form) }),
    ])
